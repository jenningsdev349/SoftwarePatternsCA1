...
public class Menu extends JFrame {
	...
	JButton deleteCustomer, deleteAccount, bankChargesButton, interestButton, editCustomerButton, navigateButton,
			summaryButton, accountButton, returnButton, continueButton;
	...
	public void menuStart() {
		...
		f = createFrame("User Type", 400, 300);

		createMenuStartScreen();

		/*
		 * REFACTOR: Implemented Strategy pattern here so when user selects any of these
		 * options, it instantiates their respective Strategy
		 */
		...
		continueButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				if (user.equals("New Customer")) {
					strategy = new NewUserLoginStrategy();
				}
				...
				if (user.equals("Customer")) {
					strategy = new CustomerLoginStrategy();
				}
				// -----------------------------------------------------------------------------------------------------------------------
			}
		});
	...
	public void admin() {
		...
		f = createFrame("Administrator Menu", 400, 400);
		f.setVisible(true);
		...
		summaryButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				f = createFrame("Summary of Transactions", 400, 700);
				...
				//* REFACTOR NOTE: Instead of having nested for loops, 1 for loop to run through every customer in the list and perform the same task *//
				for (Customer customer: customerList) {
					total += customer.getTotalTransactions();
					textArea.append(acc.getTransactionList().toString());
				}
	...
	public void customer(Customer e1) {
		f = createFrame("Customer Menu", 400, 300);
	...
	private void createMenuStartScreen() {
	...
	private void createEditCustomerScreen() {
		firstNameLabel = new JLabel("First Name:", SwingConstants.LEFT);
		surnameLabel = new JLabel("Surname:", SwingConstants.LEFT);
		pPPSLabel = new JLabel("PPS Number:", SwingConstants.LEFT);
		dOBLabel = new JLabel("Date of birth", SwingConstants.LEFT);
